...
function increaseShop () {
  if (state.currentTick - state.shop[TIKTOKKER].lastBoughtOrIncreased > 3 || state.shop[TIKTOKKER].amount == 0) {
    state.shop[TIKTOKKER].amount += 4;
    state.shop[TIKTOKKER].lastBoughtOrIncreased = state.currentTick;
  }

  if (state.currentTick - state.shop[GAMER].lastBoughtOrIncreased > 3 || state.shop[GAMER].amount == 0) {
